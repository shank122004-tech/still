...
(function () {
  ...
  const PLANS = {
    ...
    battle_academy:   { id: 'battle_academy',   name: 'Battle Creator Academy',  price: 499,  emoji: '⚔️', battleMonthly: 29 },
  ...
  window.renderPremiumModal = function () {
    ...
    <div id="upgPersonalPlans" class="upg-plans-grid">
      ...
      <div class="upg-card upg-card-popular ${(isPrem && curPlan==='semiannual') ? 'upg-card-active' : ''}">
        ...
        <div class="upg-card-tagline">Full exam cycle coverage + Free Battle Arena Pro</div>
        <div class="upg-price-row">
          <div>
            ...
            <div class="upg-save-pill">1 Month Free Battle Arena Pro!</div>
          </div>
        </div>
        ...
        <ul class="upg-features">
          ...
          <li>✦ PYQ Bank access</li>
          <li>✦ Priority AI responses</li>
          <li>✦ Priority support</li>
          <li>✦ Valid for 6 full months</li>
          <li>✦ 1 Month Free Battle Arena Pro (19 battles/mo)</li>
        </ul>
      </div>
      ...
      <div class="upg-card ${(isPrem && curPlan==='yearly') ? 'upg-card-active' : ''}">
        ...
        <div class="upg-card-tagline">Maximum productivity + Battle Arena Pro 2 Months</div>
        <div class="upg-price-row">
          <div>
            <div class="upg-price-old">₹2,388</div>
            <div style="display:flex;align-items:baseline;gap:4px;">
              <span class="upg-price" style="color:#a78bfa;">₹1,699</span>
        ...
        <ul class="upg-features">
          ...
          <li>✦ Battle Arena Pro for 2 Months (19 battles/mo)</li>
