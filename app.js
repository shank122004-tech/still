...
function canSendText()  { return state.isPremium || (state.premiumPlan && ['coaching_basic', 'coaching_pro'].includes(state.premiumPlan)) || state.textCount  < FREE_TEXT_LIMIT; }
function canSendImage() { return state.isPremium || (state.premiumPlan && ['coaching_basic', 'coaching_pro'].includes(state.premiumPlan)) || state.imageCount < FREE_IMAGE_LIMIT; }
function canSendPdf()   { return state.isPremium || (state.premiumPlan && ['coaching_basic', 'coaching_pro'].includes(state.premiumPlan)) || state.pdfCount   < FREE_PDF_LIMIT; }
