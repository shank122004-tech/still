    ...
    if (progressCard) {
      progressCard.innerHTML = `
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;">
          <span style="font-size:12px;font-weight:700;color:#fff;">🏆 Battle Creator Pro Unlocked</span>
        </div>
        <div style="background:linear-gradient(90deg,#FF6B9D,#f59e0b);border-radius:10px;padding:14px;text-align:center;">
          <div style="font-size:13px;color:#fff;font-weight:700;">20+ Referrals Achieved!</div>
          <div style="font-size:11px;color:rgba(255,255,255,0.9);margin-top:4px;">You have unlimited Battle Creator access</div>
        </div>
      `;
    }
  }
...
const TITLE_MAP = {
  ...
  ti_ethereal_being:{ label:'👻 Ethereal Being', color:'#a78bfa' },
